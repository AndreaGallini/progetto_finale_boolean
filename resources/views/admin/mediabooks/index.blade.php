            ...
            @foreach ($media as $mediabook)
                <div class="card col-12 col-md-6 my-5">
                    ...
                    <div class="card-body">
                        ...
                        <h5 class="card-title"><a href="{{ route('admin.mediabooks.show', $mediabook->slug) }}" title="View mediabook"><strong>{{
                            $mediabook->title }}</strong></a></h5>
                    </div>

                    <ul class="list-group">
                        <li class="list-group-item">Appartenente all'alloggio con <strong>id {{$mediabook->apartment_id }}</strong></li>
                        <li class="list-group-item"><strong>Url</strong><br> {!! $mediabook->img !!}</li>
                    </ul>
                    <div class="card-body d-flex justify-content-center">
                        <div class="link-edit">
                            <a href="{{ route('admin.mediabooks.edit', $mediabook->slug) }}"
                            title="Edit mediabook"><i class="fa-solid fa-pen me-2"></i>Modifica</a>
                        </div>
                        <div>
                            <form action="{{ route('admin.mediabooks.destroy', $mediabook->slug) }}" method="POST">
                                ...
                                data-item-title="{{ $mediabook->slug }}"><i class="fa-regular fa-trash-can ms-4 me-2"></i>Elimina</button>
                            </form>
                        </div>
                    </div>
                </div>
